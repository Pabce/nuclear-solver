...
@njit(float64[:,:,:,:](float64[:,:,:,:,:,:,:,:,:,:,:,:], boolean, boolean, int64, int64, int64), parallel=True, cache=True)
def n_matrix_4dflatten(matrix, m_diagonal, asym, num_states, Ne_max, l_level_max):
    dim = 4
